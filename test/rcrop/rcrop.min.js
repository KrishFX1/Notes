!function (t) {
    t.rcrop = {
        ...
        ResponsiveCrop = function (e, i) {
            ...
            var o = function () {
                ...
                , s = function (e, i, r, n) {
                    if (!1 !== e && (a.cropData.width = "number" == typeof e ? e : z(a.clayfy.newSize.width),
                        ...
                        !1 !== i && (a.cropData.height = "number" == typeof i ? i : z(a.clayfy.newSize.height),
                ...
                , f = function () {
                    ...
                    a.resize(i, e, "center", "center"),
                        ...
                        a.settings.preview.display && (a.cropArea.on("clayfy-resize clayfy-drag", w),
                ...
                , u = function () {
                    ...
                    return "string" == typeof t[0] && t[0].indexOf("%") > -1 ? e[0] = Number(t[0].replace("%", "")) / 100 * i.width : e[0] = t[0],
                ...
                , y = function () {
                    ...
                    e && (e = e instanceof t ? e : t(e)),
                        e && e.length || (e = t("<div>", {
                            ...
                            a.wrapper.after(e));
                    var i = u();
                    a.preview = t('<canvas width="' + i[0] + '" height="' + i[1] + '"></canvas>'),
            ...
            this.getValues = function () {
                ...
                this.getRealSize = function (t) {
                    ...
                    e.setAttribute("crossOrigin", "anonymous"),
                        e.onload = function () {
                            return a.image.width = this.width,
                ...
                this.getDataURL = function (e, i) {
                    e = e || a.cropData.width,
                        i = i || a.cropData.height;
                    var r = t('<canvas width="' + e + '" height="' + i + '"></canvas>');
                    return r[0].getContext("2d").drawImage(a.image.instance, a.cropData.x, a.cropData.y, a.cropData.width, a.cropData.height, 0, 0, e, i),
                        r[0].toDataURL()
                }
                ,
    ...
    t.fn[e] = function (a) {
        ...
        if ("string" == typeof a && "_" !== a[0] && "init" !== a) {
            if ("instance" === a)
                return this.length ? t.data(this[0], e) : null;
            ...
            return this.each(function () {
                var n = t.data(this, e);
                n instanceof i && "function" == typeof n[a] && n[a].apply(n, Array.prototype.slice.call(r, 1)),
...
!function () {
    function e(e, i) {
        ...
        var a, n, s = this, l = !1, d = !0, g = $("<div>", {
            style: "height:100%;width:100%;position:fixed;top:0;left:0"
        });
        this.contentGhost;
        var p = function () {
            s.settings.ghost ? (!0 === s.settings.ghost ? (s.draggableBox = s.el.clone(),
                s.draggableBox.addClass("clayfy-ghost-opacity")) : (s.draggableBox = $("<div>", {
                    margin: s.el.css("margin")
                }),
                    s.contentGhost = $('<div class="clayfy-ghost-content" style="position:absolute"></div>'),
            ...
            , f = function (e) {
                ...
                if (!0 !== s.settings.ghost && (n = {
                    ...
                    s.settings.overflow && (n.top = o.top - r,
                        n.left = o.left - a,
                        !0 !== s.settings.ghost && (n.top = e.pageY - r + 5,
                            n.left = e.pageX - a + 5)),
            ...
            , c = function (e) {
                if ("canceling" !== s.status && s.settings.move) {
                    ...
                    if (s.container.offset) {
                        ...
                        i.top >= o - s.el.outerHeight() && (t.y += o - s.el.outerHeight() - i.top),
                            i.left >= r - s.el.outerWidth() && (t.x += r - s.el.outerWidth() - i.left)
                    }
                    if (s.el.css({
                        top: t.y,
                        left: t.x
        ...
        this.cancel = function (e) {
            s.status = "canceling",
                s.draggableBox.animate({
                    ...
                    s.draggableBox.trigger("mouseup"),
                        s.status = "ready"
                }),
                null !== s.initPos.scrollTop && s.initPos.parent.animate({
                    scrollTop: s.initPos.scrollTop
                }, 100),
                null !== s.initPos.scrollLeft && s.initPos.parent.animate({
        ...
        var u, b, v, m, x = function () {
            ...
            var t = !1
                ...
                , o = $(window)
                , r = $("body");
            return e.is("body") ? (r.height() > o.height() && (i = !0),
                r.width() > o.width() && (t = !0)) : (e[0].scrollHeight > e.height() && (i = !0),
            ...
            return l.length ? (t = l[0].style.position,
                "static" === l.css("position") && l.css({
                    position: "relative"
                }),
                o = $("<div>", {
            ...
            n.x = (n.right - n.left) / 2 + n.left,
                ...
                s.history.diffDY > 0 && u && (u = !1,
                    s.y = Math.min(a.top + t.outerHeight(), e.pageY)),
                s.history.diffDY < 0 && b && (b = !1,
                    s.y = Math.max(a.top, e.pageY)),
                s.history.diffDX > 0 && m && (m = !1,
                    s.x = Math.min(a.left + t.outerWidth(), e.pageX)),
                s.history.diffDX < 0 && v && (v = !1,
                    s.x = Math.max(a.left, e.pageX));
            for (var l = 0, d = s.scrollables.length; l < d; l++) {
                ...
                if (!o(g) && f.bottom < 6 && (f.bottom > -6 || g.isBody) && f.x ? (P(e, g, "bottom"),
                    D(g, "top"),
                    p++) : (D(g, "bottom"),
                        g.el.scrollTop() && f.top < 6 && (f.top > -6 || g.isBody) && f.x ? (P(e, g, "top"),
                            p++) : D(g, "top")),
                    g.el.scrollLeft() && f.left < 6 && (f.left > -6 || g.isBody) && f.y ? (P(e, g, "left"),
                        D(g, "right"),
                        p++) : (D(g, "left"),
                            !r(g) && f.right < 6 && (f.right > -6 || g.isBody) && f.y ? (P(e, g, "right"),
                                p++) : D(g, "right")),
                    p)
                    break
            }
            ...
            o(3),
                t.isParent || (t.interval[i] = setInterval(o, 50))
        }, D = function (e, t) {
            if (t)
                e.interval[t] && (clearInterval(e.interval[t]),
                    e.interval[t] = !1);
            else
                for (var i in s.scrollables) {
                    var o = s.scrollables[i].interval;
                    for (var r in o)
                        o[r] && (clearInterval(o[r]),
                            o[r] = !1)
                }
        };
        this.appendTo = function (e, t) {
            if (t = t || s.el,
                (e = e instanceof $ ? e : $(e)).length) {
                var i = t.offset()
                    , o = e.offset()
                    , r = {
        ...
        var S = function () {
            s.el.on("clayfy-dragstart", s.updateDragElement),
                ...
                s.settings.ghost && (s.el.on("clayfy-dropinside", c),
                    s.el.on("clayfy-dropoutside", c)),
                s.el.on("clayfy-dragstart", function () {
                    X() || (s.el.removeClass("clayfy-dropinside"),
                ...
                s.el.on("clayfy-dragleave", function (e) {
                    s.el.removeClass("clayfy-dropinside"),
                        ...
                        s.el[0].id && e.droparea.removeClass("clayfy-dropinside-" + s.el[0].id)
                }),
        ...
        this.updateDropArea = function (e) {
            ...
            this.updateDragElement = function () {
                ...
                e.setCenter = function () {
                    ...
                    e.x = t.left + e.width / 2,
                        e.y = t.top + e.height / 2
                }
                    ,
                    e.setCenter(),
        ...
        var H = function (e) {
            ...
            for (var i = 0, o = s.droppable.dropArea.length; i < o; i++) {
                ...
                r && (t.x > r.left && t.x < r.right && t.y > r.top && t.y < r.bottom ? r.active = !0 : r.active = !1,
                    !r.triggered && r.active ? (r.triggered = !0,
                        s.el.trigger($.Event("clayfy-dragenter", {
                            target: r.el[0],
                            droparea: r.el
                        }))) : r.triggered && !r.active && (r.triggered = !1,
                            s.el.trigger($.Event("clayfy-dragleave", {
                                target: r.el[0],
                                droparea: r.el,
                                area: r
                            }))))
            ...
            , X = function () {
                ...
                for (var t = !1, i = 0, o = s.droppable.dropArea.length; i < o; i++) {
                    var r = s.droppable.dropArea[i];
                    r && (e.x > r.left && e.x < r.right && e.y > r.top && e.y < r.bottom && (r.active = !0,
                        r.triggered = !0,
                        t = r))
                }
                return t
            ...
            , Y = function (e) {
                ...
                t.outerWidth() < e.innerWidth && (r.right > e.offset.innerRight && (i.left = parseInt(t.css("left")) + e.offset.innerRight - r.right),
                    r.left < e.offset.innerLeft && (i.left = parseInt(t.css("left")) + e.offset.innerLeft - r.left)),
                    t.outerHeight() < e.innerHeight && (r.bottom > e.offset.innerBottom && (i.top = parseInt(t.css("top")) + e.offset.innerBottom - r.bottom),
                        r.top < e.offset.innerTop && (i.top = parseInt(s.el.css("top")) + e.offset.innerTop - r.top)),
                    s.el.css(i)
            }
            , A = function () {
            ...
            , W = function () {
                ...
                e ? (s.el.trigger($.Event("clayfy-dropinside", {
                    ...
                    s.settings.fit && Y(e)) : (s.el.trigger("clayfy-dropoutside"),
                        s.settings.dropoutside || A(),
                        s.settings.dropoutside && s.settings.migrate && s.settings.overflow && s.appendTo(s.tempContainer)),
            ...
            , C = function (e) {
                n.is(e.target) || s.el.has(e.target).length && !s.settings.propagate || (isTouchDevice() || void 0 === e.which || 1 === e.which) && (e.preventDefault(),
                    T(e) && (s.settings.coverScreen && E(),
                        l = !0,
            ...
            , R = function (e) {
                if (l) {
                    e.preventDefault(),
                        ...
                        s.settings.overflow && (s.appendTo(s.initPos.parent, s.draggableBox),
                    ...
                    s.el.trigger(t),
                        $(document).off("mousemove touchmove", I).off("mouseup touchend", R)
                }
            }
            , I = function (e) {
                if (l) {
                    ...
                    if (d) {
                        ...
                        var t = s.el.parent();
                        s.initPos.parent = t,
                            s.settings.overflow && s.appendTo(s.tempContainer, s.draggableBox),
        ...
        this.getContainerBounderies = function () {
            ...
            function () {
                s.originalPos = s.getPosition(),
                    ...
                    s.settings.escape && (s.el.on("clayfy-dragstart", function (e) {
                        e.stopPropagation(),
                            $(window).on("keydown", y)
                    }),
                    ...
                    !1 !== s.settings.scrollable && "node" === s.container.type && (s.settings.container instanceof t || ("string" == typeof s.settings.scrollable ? s.settings.scrollable = s.settings.scrollable ? s.settings.scrollable + " , " + s.settings.container : s.settings.container : s.settings.scrollable instanceof $ && (s.settings.scrollable = s.settings.scrollable.add(s.settings.container)))),
                    s.el.on("clayfy-dragstart", x),
                    s.el.on("clayfy-drag", B),
                    s.el.on("clayfy-drop", D),
                    0 != s.settings.droppable ? (s.updateDragElement(),
                        s.updateDropArea(),
                        S()) : s.settings.ghost && s.el.on("clayfy-drop", c)
            }()
    }
    function t(e, t) {
        ...
        var i = this
            ...
            , a = function (e) {
                ...
                return n.length ? (t = n[0].style.position,
        ...
        this.getDraggableValues = function () {
            ...
            ,
            function () {
                "string" == typeof t || t instanceof $ ? (i.el = t instanceof $ ? t : $(t),
                    i.type = "node",
                    "static" === i.el.css("position") && i.el.css("position", "relative"),
                    i.update = o) : (i.values = t,
                        i.type = "object",
                        i.update = r,
            ...
            this.resize = {
                left: function () {
                    n.el.width(n.actualSize.width - $.clayfy.dX),
                        "relative" !== n.cssPosition && n.el.css({
            ...
            function () {
                ...
                $.each(n.handlers, function (t, i) {
                    ...
                    n.el.on("clayfy-resizeend clayfy-drop", function (e) {
                        e.stopPropagation(),
                            n.el.parent().find(":hover").length || n.touchableDevice || (s = !1,
                                n.el.trigger("mouseout"))
                    }),
        ...
        this.updatePosition = function () {
            ...
            this.setBounderies = function (e) {
                ...
                o.resizable.actualSize = o.resizable.getSize(),
                    ...
                    (a = o.draggable.getContainerBounderies()) || (a = {
                        top: 1e13,
                        right: 1e13,
                        bottom: 1e13,
                        left: 1e13
                ...
                "left" !== o.position && "top" !== o.position && "top left" !== o.position || (n[1] = t.outerWidth - i.minSize[0],
                    ...
                    "right" !== o.position && "bottom" !== o.position && "bottom right" !== o.position || (n[3] = t.outerWidth - i.minSize[0],
                    ...
                    "bottom left" === o.position && (n[0] = t.outerHeight - i.minSize[1],
                    ...
                    "top right" === o.position && (n[0] = i.maxSize[1] - t.outerHeight,
                        n[1] = i.maxSize[0] - t.outerWidth,
                        n[2] = t.outerHeight - i.minSize[1],
            ...
            this.fixDeltas = function () {
                ...
                (o.resizable.preserveAspectRatio || o.resizable.shiftKey) && ("right" === o.position && (e.dY = e.dX / t),
                ...
                i.settings.className && o.el.addClass(i.settings.className),
                    ...
                    o.draggable.el.on("clayfy-drag", function (e) {
                        e.shiftKey && !i.preserveAspectRatio && (i.shiftKey = !0),
                            ...
                            !r || e.shiftKey || i.preserveAspectRatio || (console.log("Desactivate: preserve aspect ratio"),
                                o.draggable.bounderies = o.originalBounderies,
                                r = !1),
                            r || !e.shiftKey || i.preserveAspectRatio || (console.log("Activate: preserve aspect ratio"),
                    ...
                    t.indexOf("left") > -1 && o.draggable.el.on("clayfy-drag", function (e) {
                        (i.preserveAspectRatio || i.shiftKey) && (o.fixDeltas(),
                            "left" === t && i.resize.top()),
                            i.resize.left()
                    }),
                    ...
                    t.indexOf("right") > -1 && o.draggable.el.on("clayfy-drag", function (e) {
                        (i.preserveAspectRatio || i.shiftKey) && (o.fixDeltas(),
                            "right" === t && i.resize.bottom()),
                            i.resize.right()
                    }),
                    t.indexOf("bottom") > -1 && o.draggable.el.on("clayfy-drag", function (e) {
                        (i.preserveAspectRatio || i.shiftKey) && (o.fixDeltas(),
                            "bottom" === t && i.resize.right()),
                            i.resize.bottom()
                    }),
                    o.draggable.el.on("clayfy-drag", function (e) {
                        i.el.trigger("clayfy-resize"),
                            i.settings.callbacks.resize()
                    }),
    ...
    function r(t, i) {
        ...
        var o, r = this, a = function (e) {
            ...
            f(),
                (!1 === r.el.triggerHandler("validateChange") || !r.parent.is($(r.droppedTarget).parent()) && !r.settings.export || o) && d();
            ...
            return r.draggableBox.animate({
                ...
                e != r.index && (r.index = e,
                    r.el.trigger($.Event("clayfy-changeorder", {
                        index: r.index,
                        order: r.droppable
                    }))),
            ...
            if (!r.el.is(e.target)) {
                ...
                r.droppedTarget = e.target,
                    ...
                    r.parent.find(r.droppable).length < 2 ? r.parent.find(".clayfy-sort-helper").length || r.parent.append('<div class="clayfy-sort-helper" style="position: absolute; width: 100%; height: 100%; top: 0; left:0"></div>') : r.parent.find(".clayfy-sort-helper").remove(),
    ...
    $.fn.clayfy = function (t) {
        ...
        if (void 0 === t || "object" == typeof t) {
            ...
            switch (void 0 !== t && void 0 !== t.type && (n = t.type),
            n) {
                case "draggable":
                    a = e;
                    break;
